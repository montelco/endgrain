...
@section('alerts')
	<h1>Check out our store for new beans.</h1>
	<h3>Everything from decaf to special edition blends. <strong><a href="http://store.endgrain.coffee"> Shop now...</a></strong></h3>
@stop
@section('intro')
